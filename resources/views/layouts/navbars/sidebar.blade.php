<nav class="navbar navbar-vertical fixed-left navbar-expand-md" id="sidenav-main" style="background-color: #FFF">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="{{ route('home') }}">
            <img src="{{ asset('argon') }}/img/brand/mozika.png" class="navbar-brand-img" alt="...">
        </a>
        <!-- User -->
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#navbar-cadastro" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="navbar-examples">
