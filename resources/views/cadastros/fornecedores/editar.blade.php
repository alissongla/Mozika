                    ...
                    <form role="form" method="POST" action="{{ route('AtualizarFornecedor', $fornecedor->FOR_ID) }}">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control" placeholder="{{ __('Telefone') }}" type="text" name="FOR_TELEFONE" value="{{ $fornecedor->FOR_TELEFONE}}">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control" placeholder="{{ __('Documento') }}" type="text" name="FOR_DOCUMENTO" value="{{ $fornecedor->FOR_DOCUMENTO }}">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-3">
