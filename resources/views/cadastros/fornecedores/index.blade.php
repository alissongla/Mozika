                    ...
                    <form role="form" method="POST" action="{{ route('CadastroFornecedor') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control tel_ddd" placeholder="{{ __('Telefone') }}" type="text" name="FOR_TELEFONE">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-3">
                                    ...
                                    <input class="form-control cpfCnpjMask" placeholder="{{ __('Documento') }}" type="text" name="FOR_DOCUMENTO">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group input-group-alternative mb-3">
                ...
                <div class="card bg-gradient-secondary shadow">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                    ...
                                    <tr>
                                        ...
                                        <td class='text-right' style="width: 140px;">
                                            <a class='btn btn-warning btn-sm'
                                                href='{{ route("EditarFornecedor", $fornecedor->FOR_ID) }}' role='button' style="margin-right: -40px;">
                                                <i class='ni ni-settings'></i>
                                            </a>
                                        </td>
                                        <td>
                                            <form method="post" action="{{ route('ApagarFornecedor', $fornecedor->FOR_ID) }}"
                                                style="">
                                                {{ csrf_field() }}
                                                {{ method_field('DELETE') }}
                            ...
                            @include('pagination.default', ['paginator' => $fornecedores])
                        </div>
                    </div>
                </div>
            </div>
